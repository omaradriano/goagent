-- CleanUser debe borrar tambien las filas de polizas_audit_log antes de
-- borrar las polizas, o la FK polizas_audit_log_poliza_id_fkey lo bloquea
-- (SQLSTATE 23503) - la tabla de auditoria no existia con datos reales
-- cuando se escribio CleanUser originalmente.
