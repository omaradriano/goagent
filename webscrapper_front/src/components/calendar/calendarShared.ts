...
// Piezas comunes de los calendarios (cumpleanos y aniversarios de poliza):
// localizer en espanol, helpers de fechas y estilos. El toolbar va en
// CalendarToolbar.tsx.
...
// Cuantos eventos proximos se listan en el panel lateral (la lista hace
...
export const ITEM_CLASS = "border-solid border-0 border-b border-[var(--ga-surface-border)]";
...
export const CONTENT_CLASS = "pt-1 pb-3";

// El backend manda las fechas (cumpleanos, aniversarios) como YYYY-MM-DD; se
// arma la fecha local sin pasar por UTC para que la zona horaria no la mueva
// un dia.
...
export const calendarFormats: Formats = {
  weekdayFormat: (date, culture, loc) =>
    capitalize(loc!.format(date, "ddd", culture).replace(".", "")),
...
export const LoadingBox = styled(Surface)`
  display: flex;
  flex-direction: column;
  align-items: center;
  justify-content: center;
...
// Aviso informativo en azul suave (p. ej. la ventana de fechas que se
// muestra).
...
export const ToolbarLabel = styled.h2`
  font-size: 18px;
  font-weight: 700;
...
export const CalendarSurface = styled(Surface)`
  padding: 20px;
  min-width: 0;
  ...
  .rbc-day-slot .rbc-background-event {
    ...
    /* Fechas que ya pasaron: gris en lugar de azul */
    &.is-past {
      background-color: var(--ga-surface-soft);
      color: var(--ga-muted);
...
// ── Panel lateral (proximos / recientes) ──────────────────────────────────────────────
export const Upcoming = styled(Surface)`
  padding: 4px 16px;
`;
...
export const UpcomingCount = styled.span`
  font-size: 12px;
  font-weight: 600;
  padding: 2px 10px;
  border-radius: 20px;
...
// polizas. Las fechas que ya pasaron van atenuadas.
export const UpcomingRow = styled.button<{ $past: boolean }>`
  display: flex;
  align-items: center;
  gap: 12px;
  width: 100%;
...
export const DateBadge = styled.div<{ $adicional: boolean }>`
  display: flex;
  flex-direction: column;
  align-items: center;
  justify-content: center;
...
// neutro.
export const DaysPill = styled.span<{ $days: number }>`
  flex-shrink: 0;
  font-size: 11px;
  font-weight: 600;
  padding: 3px 10px;
...
export const EventIconBox = styled.span`
  display: flex;
  align-items: center;
  justify-content: center;
  width: 32px;
...
export const AdicionalNote = styled.p`
  margin-top: -6px;
  font-size: 12px;
  font-weight: 500;
  color: var(--ga-violet);
